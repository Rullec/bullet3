...
typedef std::vector<tVector3d, Eigen::aligned_allocator<tVector3d>> EIGEN_V_tVector3d;
typedef std::vector<EIGEN_V_tVector3d, Eigen::aligned_allocator<EIGEN_V_tVector3d>> EIGEN_VV_tVector3d;
typedef std::vector<tVector3f, Eigen::aligned_allocator<tVector3f>> EIGEN_V_tVector3f;
typedef std::vector<tVector, Eigen::aligned_allocator<tVector>> EIGEN_V_tVector;
typedef std::vector<tVectorXd, Eigen::aligned_allocator<tVectorXd>> EIGEN_V_VECXD;
typedef std::vector<tMatrix, Eigen::aligned_allocator<tMatrix>> EIGEN_V_tMatrixD;
typedef std::vector<tMatrixXd, Eigen::aligned_allocator<tMatrixXd>> EIGEN_V_MATXD;
typedef std::vector<tMatrix3d, Eigen::aligned_allocator<tMatrix3d>> EIGEN_V_tMatrix3dD;
typedef std::vector<EIGEN_V_MATXD, Eigen::aligned_allocator<EIGEN_V_MATXD>> EIGEN_VV_MATXD;
typedef std::vector<EIGEN_V_tMatrixD, Eigen::aligned_allocator<EIGEN_V_tMatrixD>> EIGEN_VV_tMatrixD;
typedef std::vector<EIGEN_VV_tMatrixD, Eigen::aligned_allocator<EIGEN_VV_tMatrixD>> EIGEN_VVV_tMatrixD;
