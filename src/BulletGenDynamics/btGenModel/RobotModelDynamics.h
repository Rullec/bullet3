...
public:
	...
	// ----------------------simulation APIs----------------------
	void InitSimVars(btDynamicsWorld* world, bool zero_pose, bool zero_pose_vel, bool enable_collision = true);
	...
	tVectorXd CalcGenGravity(const tVector& g) const;  // calculate the generalized gravity, sometimes useful in external calculationI
...
protected:
	...
	// std::vector<btCollisionShape*> mColShapes;   // used in bullet collision detection for multibody structure
