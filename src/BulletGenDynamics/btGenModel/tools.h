...
public:
    ...
    static double ConvertUnitInv(double d) { return d * 17.7305; }
    ...
    static tVector3d RadToDeg(tVector3d angle) { return angle / M_PI * 180; }
    ...
    static tVector3d RotationMatrix2EulerAngles(tMatrix3d rot)
    {
        ...
        double theta_y = atan2(
            -rot(2, 0), sqrt(rot(2, 1) * rot(2, 1) + rot(2, 2) * rot(2, 2)));
    ...
    static Eigen::Quaterniond RotationMatrix2Quaternion(const tMatrix3d &mat)
    {
        ...
        {
            double S =
                sqrt(1.0 + mat(0, 0) - mat(1, 1) - mat(2, 2)) * 2; // S=4*qx
        ...
        {
            double S =
                sqrt(1.0 + mat(1, 1) - mat(0, 0) - mat(2, 2)) * 2; // S=4*qy
        ...
        {
            double S =
                sqrt(1.0 + mat(2, 2) - mat(0, 0) - mat(1, 1)) * 2; // S=4*qz
    ...
    static tVector3d CalcQuaternionVel(const Eigen::Quaterniond &q0,
                                       const Eigen::Quaterniond &q1, double dt)
    {
    ...
    static void QuaternionToAxisAngle(const Eigen::Quaterniond &q,
                                      tVector3d &out_axis, double &out_theta)
    {
        out_theta = 0;
    ...
    static void AVX4x4v1_3mat(const tMatrix &a, const tMatrix &b,
                              const tMatrix &c, tMatrix &r);
    static void AVX4x4v1_6mat(const tMatrix &a, const tMatrix &b,
                              const tMatrix &c, const tMatrix &d,
                              const tMatrix &e, const tMatrix &f, tMatrix &r);
