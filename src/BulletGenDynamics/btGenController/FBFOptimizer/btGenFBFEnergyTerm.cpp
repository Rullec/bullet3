...
#include <iostream>
btGenFrameByFrameEnergyTerm::btGenFrameByFrameEnergyTerm(int size_of_solution_vector) : mSolutionSize(size_of_solution_vector)
{
	mAlist.resize(0);
	mblist.resize(0);
...
void btGenFrameByFrameEnergyTerm::AddEnergy(const tMatrixXd &Jacobian, const tVectorXd &residual, int st_pos)
{
