...
protected:
    ...
    std::map<int, int>
        map_world_contact_id_to_local_contact_id; // map the global contact id
                                                  // to the index in
                                                  // "mContactPts" aka local
                                                  // contact id
    std::map<int, int>
        map_local_contact_id_to_self_contact_id; // map the local contact id to
                                                 // the index of self contact id
    std::map<int, int>
