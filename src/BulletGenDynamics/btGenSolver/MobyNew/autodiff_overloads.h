...
template <typename DerType> bool isinf(const Eigen::AutoDiffScalar<DerType> &x)
{
    using std::isinf;
...
template <typename DerType> bool isnan(const Eigen::AutoDiffScalar<DerType> &x)
{
    using std::isnan;
...
template <typename DerType> double ceil(const Eigen::AutoDiffScalar<DerType> &x)
{
    using std::ceil;
    return ceil(x.value());
}
...
template <typename DerType> struct dummy_value<Eigen::AutoDiffScalar<DerType>>
{
